        ...
        pages: [
          {
            ...
            items: [
              ...
              },
              {
                ...
                text: ['Underfitting ', 'Overfitting ', 'Cost Function '],
              },
              {
                id: 'faq-6',
                title: 'Regression',
              ...
              },
              {
                ...
                text: ['K-means Clustering', 'Hierarchical Clustering'],
              },
              {
                id: 'faq-9',
            ...
            outcome: [
              {
                ...
                desc: `Welcome to "MERN Stack Front To Back". In this course we will build an in-depth full stack E-commerce application using Node.js, Express, React, Redux and MongoDB along with ES6+. We will start with a blank text editor and end with a deployed full stack application. This course includes... `,
              },
            ],
            feature: [
              {
...

          {
            ...
            items: [
              ...
              },
              {
                id: 'faq-5',
                title:
                  'Exploring Container, Single Child and Multiple Children ',
